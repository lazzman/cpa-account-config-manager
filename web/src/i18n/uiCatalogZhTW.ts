...
export const zhTWUI: Record<UIMessageKey, string> = {
  ...
  "ui.headers": "請求標頭",
	...
	"ui.proxy_credentials_hidden": "Proxy 憑證已隱藏；勾選 Proxy 欄位後將設定新位址或清除現有設定。模板會依帳號展開，最終密鑰不會顯示在此處。",
  ...
  "ui.proxy_url_template_help": "可選的依帳號展開黏性代理模板。可使用 {email_local}、{session}、{uuid}、{id}、{name_stem}、{index}、{rand8} 等占位符，讓每個帳號取得不同的代理使用者名稱。",
  "ui.proxy_url_template_placeholder": "socks5h://{email_local}-{uuid}@127.0.0.1:1080",
  "ui.proxy_url_template_preview_warning": "Proxy URL 使用了黏性模板。每個可編輯帳號都會寫入各自展開後的代理位址。",
