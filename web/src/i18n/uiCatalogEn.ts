export const enUI = {
  ...
  "ui.headers": "Headers",
	...
	"ui.proxy_credentials_hidden": "Proxy credentials are hidden. Checking Proxy replaces or clears the current address. Templates expand per account without showing the final secrets here.",
  ...
  "ui.proxy_url_template_help": "Optional per-account sticky template. Use {email_local}, {session}, {uuid}, {id}, {name_stem}, {index}, {rand8}, and similar placeholders so each account gets a unique proxy username.",
  "ui.proxy_url_template_placeholder": "socks5h://{email_local}-{uuid}@127.0.0.1:1080",
  "ui.proxy_url_template_preview_warning": "Proxy URL uses a sticky template. Each eligible account will receive its own expanded proxy address.",
