...
export const zhCNUI: Record<UIMessageKey, string> = {
  ...
  "ui.headers": "请求头",
	...
	"ui.proxy_credentials_hidden": "代理凭据已隐藏；勾选代理字段后将设置新地址或清除现有配置。模板会按账号展开，最终密钥不会在此处显示。",
  ...
  "ui.proxy_url_template_help": "可选按账号展开的粘性代理模板。可使用 {email_local}、{session}、{uuid}、{id}、{name_stem}、{index}、{rand8} 等占位符，让每个账号获得不同的代理用户名。",
  "ui.proxy_url_template_placeholder": "socks5h://{email_local}-{uuid}@127.0.0.1:1080",
  "ui.proxy_url_template_preview_warning": "代理 URL 使用了粘性模板。每个可编辑账号都会写入各自展开后的代理地址。",
