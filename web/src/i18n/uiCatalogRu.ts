...
export const ruUI: Record<UIMessageKey, string> = {
  ...
  "ui.headers": "Заголовки",
	...
	"ui.proxy_credentials_hidden": "Учётные данные прокси скрыты. Выбор поля прокси заменит или очистит текущий адрес. Шаблоны раскрываются для каждого аккаунта, итоговые секреты здесь не показываются.",
  ...
  "ui.proxy_url_template_help": "Необязательный sticky-шаблон на аккаунт. Используйте {email_local}, {session}, {uuid}, {id}, {name_stem}, {index}, {rand8} и похожие плейсхолдеры, чтобы у каждого аккаунта был свой proxy-username.",
  "ui.proxy_url_template_placeholder": "socks5h://{email_local}-{uuid}@127.0.0.1:1080",
  "ui.proxy_url_template_preview_warning": "Proxy URL использует sticky-шаблон. Каждый подходящий аккаунт получит собственный развёрнутый адрес прокси.",
